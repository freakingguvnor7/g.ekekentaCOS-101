// Rust program to calculate thhe area of a triangle given three sides 
...
fn main() {
    ...
    let a:f32 = input1.trim().parse().expect("Not a valiid number");
    ...
    let c:f32 = input3.trim().parse().expect("Not a valud number");
